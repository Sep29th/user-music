...
const FooterUserLayoutAudioPlayer = () => {
  const [audioLists, setAudioLists] = useState([
    // {
    //   musicSrc:
    //     "https://musicwebsite.s3.ap-east-1.amazonaws.com/song/sounds/00b1c8f6ac574a46a790aa2b85135a7d.mp3",
    //   name: "Hoang",
    //   cover:
    //     "https://bloganchoi.com/wp-content/uploads/2023/10/loi-bai-hat-cat-doi-noi-sau-tang-duy-tan-4-696x385.jpg",
    //   singer: "Tong Duy Tan",
    //   lyric:
    //     "[id: atufcpbm]\n" +
    //     "[ar: Sia]\n" +
